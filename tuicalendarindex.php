...
/**
 *  \file       tuicalendar/tuicalendarindex.php
 *  \ingroup    tuicalendar
 *  \brief      Home page of tuicalendar top menu
 */
...
llxHeader("", $langs->trans("TuiCalendarArea"));

print load_fiche_titre($langs->trans("TuiCalendarArea"), '', 'tuicalendar.png@tuicalendar');
