 ...
 * Copyright (C) 2019 Frédéric FRANCE <frederic@fredericfrance.onmicrosoft.com>
 *
...
/**
 * \file    test/functional/TuiCalendarFunctionalTest.php
 * \ingroup tuicalendar
...
/**
 * Class TuiCalendarFunctionalTest
 *
 ...
 *
 * @package Testtuicalendar
 */
class TuiCalendarFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
    ...
    public function testModuleEnabled()
    {
        ...
        if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
            // Enable the module
            $this->byHref('modTuiCalendar')->click();
        } else {
            // Disable the module
            $this->byHref('modTuiCalendar')->click();
            // Reenable the module
    ...
    {
        $this->url('/custom/tuicalendar/admin/setup.php');
        $this->authenticate();
        return $this->assertContains('tuicalendar/admin/setup.php', $this->url(), 'Configuration page');
    }
    ...
    {
        $this->url('/custom/tuicalendar/admin/about.php');
        $this->authenticate();
        return $this->assertContains('tuicalendar/admin/about.php', $this->url(), 'About page');
    }
    ...
    public function testBoxDeclared()
    {
        ...
        $this->authenticate();
        return $this->assertContains('tuicalendarwidget1', $this->source(), "Box enabled");
    }
    ...
    public function testTriggerDeclared()
    {
        ...
        return $this->assertContains(
            'interface_99_modTuiCalendar_TuiCalendarTriggers.class.php',
    ...
    public function testTriggerEnabled()
    {
        ...
        return $this->assertContains(
            'tick.png',
            $this->byXPath('//td[text()="interface_99_modTuiCalendar_MyTrigger.class.php"]/following::img')->attribute('src'),
            "Trigger enabled"
        );
    }
