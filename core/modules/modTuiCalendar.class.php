...
/**
 * \defgroup   tuicalendar     Module TuiCalendar
 * \brief      TuiCalendar module descriptor.
 *
 * \file       htdocs/tuicalendar/core/modules/modTuiCalendar.class.php
 * \ingroup    tuicalendar
 * \brief      Description and activation file for module TuiCalendar
 */
...
class modTuiCalendar extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 14011966; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'tuicalendar';
		...
		// Module label (no space allowed), used if translation string 'ModuleTuiCalendarName' not found (TuiCalendar is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));
		// Module description, used if translation string 'ModuleTuiCalendarDesc' not found (TuiCalendar is name of module).
		...
		// $this->editor_url = 'https://free.fr';
		// Possible values for version are: 'development', 'experimental', 'dolibarr', 'dolibarr_deprecated' or a version string like 'x.y.z'
		$this->version = '1.1.0';
		// Url to the file with your last numberversion of this module
		//$this->url_last_version = 'http://www.example.com/versionmodule.txt';

		// Key used in llx_const table to save module status enabled/disabled (where TUICALENDAR is value of property name of module in uppercase)
		...
		$this->cronjobs = [
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/tuicalendar/class/myobject.class.php',
			//      'objectname' => 'MyObject',
		...
		// Permission label
		$this->rights[$r][1] = 'Read objects of TuiCalendar';
		$this->rights[$r][3] = 1;
		// In php code, permission will be checked by test if ($user->rights->tuicalendar->level1->level2)
		$this->rights[$r][4] = 'read';
		// In php code, permission will be checked by test if ($user->rights->tuicalendar->level1->level2)
		$this->rights[$r][5] = '';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Create/Update objects of TuiCalendar';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'write';
		$this->rights[$r][5] = '';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Delete objects of TuiCalendar';
		$this->rights[$r][3] = 0;
	...
	{
		$result = $this->_load_tables('/tuicalendar/sql/');
		if ($result < 0) {
		...
		//$result1=$extrafields->addExtraField('myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'tuicalendar@tuicalendar', '$conf->tuicalendar->enabled');
		//$result2=$extrafields->addExtraField('myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'tuicalendar@tuicalendar', '$conf->tuicalendar->enabled');
		//$result3=$extrafields->addExtraField('myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'tuicalendar@tuicalendar', '$conf->tuicalendar->enabled');
