...
/**
 * \file    core/triggers/interface_99_modTuiCalendar_TuiCalendarTriggers.class.php
 * \ingroup tuicalendar
 ...
 *      - interface_99_modTuiCalendar_MyTrigger.class.php
...
/**
 *  Class of triggers for TuiCalendar module
 */
class InterfaceTuiCalendarTriggers extends DolibarrTriggers
{
    ...
    public function __construct($db)
    {
        ...
        $this->description = "TuiCalendar triggers.";
    ...
    {
        if (empty($conf->tuicalendar->enabled)) {
        ...
        switch ($action) {
            ...
            case 'ACTION_DELETE':
                if ($object->oldcopy->id > 0) {
                    ...
                    dol_syslog("tui calendar add deleted event: " . $sql, LOG_NOTICE);
                    $this->db->query($sql);
                }
                break;
